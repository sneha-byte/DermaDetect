    ...
    return (
        <div className="flex gap-5 h-16 w-full px-8 sm:px-6 lg:px-8 items-center bg-burgundy-300">
            <div className="flex items-center">
                ...
                <span className="text-xl font-bold text-burgundy-900">
                    DermaDetect
                </span>
            </div>
            <div className="w-full flex justify-baseline gap-5 sm:ml-6 sm:flex sm:space-x-8">
                <Link
                    to="/"
                    className="text-burgundy-900 no-underline hover:text-burgundy-700 inline-flex items-center px-1 pt-1 font-medium text-lg"
                >
                    Home
                </Link>
                <Link
