      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <section className="mb-12 text-center">
          ...
          <p className="text-black text-lg mb-8">
            Locate a qualified dermatologist in your area for professional skin examination and treatment.
          </p>
          ...
          <div className="max-w-md mx-auto mb-12">
            ...
            <div className="flex items-center border border-black rounded-md overflow-hidden">
              ...
              />
              <label className="rounded-md bg-burgundy-700 hover:bg-burgundy-800 text-white p-3 flex items-center justify-center transition-colors">
